$(function () {
    ...
    $('#to_xlsx').on('click', function (e) {
        e.preventDefault();
        window.location.href = 'lka_ma/getExcelReport?dateFrom=' + $('#dateFrom').val() +
                '&dateTo=' + $('#dateTo').val();
    });
});
